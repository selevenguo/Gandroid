 ...
 *******************************************************************************/
package com.name.projectname.utils.universalimageloader.core;
...
import com.name.projectname.utils.universalimageloader.cache.disc.DiscCacheAware;
import com.name.projectname.utils.universalimageloader.cache.disc.impl.UnlimitedDiscCache;
import com.name.projectname.utils.universalimageloader.cache.disc.naming.FileNameGenerator;
import com.name.projectname.utils.universalimageloader.cache.memory.MemoryCacheAware;
import com.name.projectname.utils.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
...
import com.name.projectname.utils.universalimageloader.core.decode.ImageDecoder;
import com.name.projectname.utils.universalimageloader.core.download.ImageDownloader;
import com.name.projectname.utils.universalimageloader.core.download.NetworkDeniedImageDownloader;
import com.name.projectname.utils.universalimageloader.core.download.SlowNetworkImageDownloader;
import com.name.projectname.utils.universalimageloader.core.process.BitmapProcessor;
import com.name.projectname.utils.universalimageloader.utils.L;
import com.name.projectname.utils.universalimageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		 ...
		 * {@link com.name.projectname.util.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.name.projectname.util.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.name.projectname.util.universalimageloader.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.name.projectname.util.universalimageloader.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value -
		 * {@link com.name.projectname.util.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value -
		 * {@link com.name.projectname.util.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.name.projectname.util.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Default value - {@link com.name.projectname.util.universalimageloader.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link com.name.projectname.util.universalimageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Consider {@link com.name.projectname.util.universalimageloader.utils.L#disableLogging()} to disable ImageLoader logging completely (even error logs)
		 */
