 ...
 * through {@link com.name.projectname.util.universalimageloader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link android.view.View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.name.projectname.util.universalimageloader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain com.name.projectname.util.universalimageloader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link com.name.projectname.util.universalimageloader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain com.name.projectname.util.universalimageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *android.graphics.drawable.Drawable) for empty Uri},
	 * {@linkplain com.name.projectname.util.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *android.graphics.drawable.Drawable) on loading} or
	 * {@linkplain com.name.projectname.util.universalimageloader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.name.projectname.util.universalimageloader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.name.projectname.util.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.
	 *
	 ...
	 * {@link com.name.projectname.util.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.
	 *
