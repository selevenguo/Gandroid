...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.name.projectname.util.universalimageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
