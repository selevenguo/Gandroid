 ...
 *******************************************************************************/
package com.name.projectname.widget.pulltorefresh.library.internal;
...
import com.name.projectname.widget.pulltorefresh.library.ILoadingLayout;
import com.name.projectname.widget.pulltorefresh.library.PullToRefreshBase.Mode;
import com.name.projectname.widget.pulltorefresh.library.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout implements
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		textMode = attrs.getInteger(R.styleable.PullToRefresh_prtTextMode, 0);
		if (textMode == 1) {
			if (mode == Mode.PULL_FROM_START) {
				mPullLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrHeaderText);
			} else {
				mPullLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrFooterText);
			}
		}
		if (textMode == 2)
			hideAllViews();
